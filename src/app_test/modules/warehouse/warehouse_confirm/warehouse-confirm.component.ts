...
@Component({
  selector: 'as-warehouse-confirm',
  templateUrl: './warehouse-confirm.component.html',
  styleUrls: ['./warehouse-confirm.component.css']
})
export class WarehouseConfirmComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.shipData = JSON.parse(<string>localStorage.getItem('shipDetail'));
    this.userInfo = JSON.parse(<string>localStorage.getItem('data'));
  }
